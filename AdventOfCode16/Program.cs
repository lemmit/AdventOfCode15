...
namespace AdventOfCode16
{
    ...
    {
        public static IEnumerable<AuntData> IfHasPropertyThenWithValue(this IEnumerable<AuntData> aunts, string property, int value)
        {
            return aunts
                .Where(aunt =>
        ...
        public static IEnumerable<AuntData> IfHasPropertyThenGreaterThanValue(this IEnumerable<AuntData> aunts, string property, int value)
        {
            return aunts
                .Where(aunt =>
                        (aunt.Item2 != property && aunt.Item4 != property && aunt.Item6 != property)
        ...
        public static IEnumerable<AuntData> IfHasPropertyThenLesserThanValue(this IEnumerable<AuntData> aunts, string property, int value)
        {
            return aunts
                .Where(aunt =>
                        (aunt.Item2 != property && aunt.Item4 != property && aunt.Item6 != property)
    ...
    class AuntData : Tuple<int, string, int, string, int, string, int>
    {
        public AuntData(int auntNumber, 
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            perfumes: 1
            */
            var aunts = GetInputData().IfHasPropertyThenWithValue("children", 3)
            ...
            {
                System.Console.WriteLine($"{aunt}");
            }
            System.Console.ReadLine();
        }
        
        static IEnumerable<AuntData> GetInputData()
        {
        ...
        static AuntData ExtractData(string line)
        {
        ...
        const string InputData = @"Sue 1: cars: 9, akitas: 3, goldfish: 0
